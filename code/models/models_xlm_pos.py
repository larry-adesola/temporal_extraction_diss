...
class XLMTemporalRelationClassificationWithPOSEmbedding(XLMRobertaPreTrainedModel):
  config_class = XLMRobertaConfig
  base_model_prefix = "roberta"

  def __init__(self, config, dataset=None, pos_vocab_size=100, pos_dim=16):
    super(XLMTemporalRelationClassificationWithPOSEmbedding, self).__init__(config)
